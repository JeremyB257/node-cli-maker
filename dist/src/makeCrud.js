...
export function makeCrud(entity, options = {}) {
    ...
    try {
        ...
        console.error(`❌ Erreur lors de la migration !, N'oubliez pas de migrer la modification 'npx prisma migrate dev --name add_${entityLower}_table'`);
    }
